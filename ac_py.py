...
class AcPy:
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('AcPy', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/AcPy/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'AcPy'),
            callback=self.run,
    ...
    def run(self):
        ...
        if not self.pluginIsActive:
            ...
            if self.dockwidget == None:
                ...
                self.dockwidget = AcPyDockWidget()
